$(document).ready(function () {
    ...
    function fillTable(items) {
        ...
        items.forEach( function (item) {
            trHTML += '<tr>' +
                ...
                '<td>' + '<button class="jsEditButton" type="button" value="'+ item.id +'">'+
            'Edit' + '</button></td>' +
                '<td>' + '<button class="jsDeleteButton" type="button"  value="' + item.id + '">'+
                'Delete' + '</button></td>' +
            '</tr>';
        });
        trHTML += '</tbody>\n' +
    ...
    function successEditMessage () {
        $(".showAjax").html(json);
        let respContent = "";
        respContent += "<span class='success'>Book successful edited</span>";
        $(".addBookFromResponse").html(respContent);
    }
